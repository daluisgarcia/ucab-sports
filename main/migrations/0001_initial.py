...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(to='main.Modalidades'),
        ),
        migrations.CreateModel(
            name='Fases',
            fields=[
                ...
                ('id_mod_fase', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='main.modalidades_fase')),
            ],
            options={
                'verbose_name': 'Fase',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_modalidad', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.modalidades_fase')),
            ],
        ),
    ]
