# Generated by Django 3.1.3 on 2020-12-31 17:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_organizador', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='main.organizer')),
                ('id_torneo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='main.tournament', verbose_name='Torneo del post')),
            ],
            options={
                'verbose_name': 'Post',
